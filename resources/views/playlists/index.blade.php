            ...
            <div class="card shadow playlist-card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center gap-2">
                        <a href="{{ route('playlists.show', $playlist) }}" class="btn btn-primary">View Playlist</a>                     
                        <a href="{{ route('playlists.create') }}" class="btn btn-secondary"><i class="fa-solid fa-pen"></i> Edit</a>
                    </div>
                </div>
            </div>
        </div>
